...
#define TRAFFIC_LIGHT_LEFT_X ROAD_VERTICAL_X - TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_LEFT_Y ROAD_HORIZONTAL_Y + ROAD_WIDTH + TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_TOP_X ROAD_VERTICAL_X - TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_TOP_Y ROAD_HORIZONTAL_Y - TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_RIGHT_X ROAD_VERTICAL_X + ROAD_WIDTH + TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_RIGHT_Y ROAD_HORIZONTAL_Y - TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_BOTTOM_X ROAD_VERTICAL_X + ROAD_WIDTH + TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_BOTTOM_Y ROAD_HORIZONTAL_Y + ROAD_WIDTH + TRAFFIC_LIGHT_SPACING
#define TRAFFIC_LIGHT_ID_LEFT   0
#define TRAFFIC_LIGHT_ID_TOP    1
#define TRAFFIC_LIGHT_ID_RIGHT  2
#define TRAFFIC_LIGHT_ID_BOTTOM 3
